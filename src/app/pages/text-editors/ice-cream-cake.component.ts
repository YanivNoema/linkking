...
@Component({
  selector: 'app-ice-cream-cake-recipes',
  templateUrl: '../../general-codes/html/text-editors.component.html',
  styleUrls: ['../../general-codes/css/text-editors.component.css']
})
export class IceCreamRecipesComponent implements OnInit {
  newText: string;
  itemName = 'ice-cream-cake-recipes';
  // socials: Social[] = [];
  // articleTitle: string = "The Best Text Editors";
  // articleMessage: string = " You can use your vote, up to 3 times, every 4 hours";
  // returnVotingMessage: string = "You can return voting in 4 hours!";
  cookieValue: string;
  maxVotes = 3;
  cookieExpire = 0.1;
